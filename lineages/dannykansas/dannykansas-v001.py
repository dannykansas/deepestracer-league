...
⁄
    ...
    print('track_width = {}'.format(track_width))
    
    marker_1 = 0.01 * track_width
    marker_125 = 0.0125 * track_width
    marker_150 = 0.025 * track_width
    marker_175 = 0.05 * track_width
    ...
    if distance_from_center >= 0.0 and distance_from_center <= marker_1:
        reward = 3.125
    elif distance_from_center <= marker_125:
        reward = 3
    elif distance_from_center <= marker_150:
        reward =  2
    elif distance_from_center <= marker_175:
        reward = 1.25
        ...
        reward = 0.00001  # very close to being off track
